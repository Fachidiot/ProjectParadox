...
/// <summary>재료 탭. 템플릿 복제 + 6좌표 페이징, 최근 획득 순 정렬</summary>
public class Control_ItemTab : ControlBase
{
    ...
    private void Refresh()
    {
        ...
        if (m_PrevButton != null) m_PrevButton.gameObject.SetActive(m_Page > 0);
        if (m_NextButton != null) m_NextButton.gameObject.SetActive(m_Page < maxPage);
    }
